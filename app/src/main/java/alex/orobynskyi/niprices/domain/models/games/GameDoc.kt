...
data class GameDoc(
    ...
    @ColumnInfo(name="compatible_controller") val compatible_controller: List<String>,
    @ColumnInfo(name="copyright_s") val copyright_s: String,
    @ColumnInfo(name="date_from") val date_from: String,
    @ColumnInfo(name="dates_released_dts") val dates_released_dts: List<String>,
    @ColumnInfo(name="digital_version_b") val digital_version_b: Boolean,
    @ColumnInfo(name="excerpt") val excerpt: String,
    @ColumnInfo(name="fs_id") val fs_id: String,
    @ColumnInfo(name="game_categories_txt") val game_categories_txt: List<String>,
    @ColumnInfo(name="game_category") val game_category: List<String>,
    ...
    @ColumnInfo(name="language_availability") val language_availability: List<String>,
    @ColumnInfo(name="nsuid_txt") val nsuid_txt: List<String>,
    ...
    @ColumnInfo(name="playable_on_txt") val playable_on_txt: List<String>,
    ...
    @ColumnInfo(name="pretty_game_categories_txt") val pretty_game_categories_txt: List<String>,
    ...
    @ColumnInfo(name="product_code_ss") val product_code_ss: List<String>,
    @ColumnInfo(name="product_code_txt") val product_code_txt: List<String>,
    ...
    @ColumnInfo(name="system_names_txt") val system_names_txt: List<String>,
    @ColumnInfo(name="system_type") val system_type: List<String>,
    @ColumnInfo(name="title") val title: String,
    @ColumnInfo(name="vetitle_extras_txtrsion") val title_extras_txt: List<String>,
